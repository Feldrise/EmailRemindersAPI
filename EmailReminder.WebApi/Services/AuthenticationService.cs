...
namespace EmailReminder.WebApi.Services
{
    public class AuthenticationService : IAuthenticationSercice
    {
        ...
        public AuthenticationService(UserManager<IdentityUser> userManager, ApplicationDbContext context, IBackgroundJobClient backgroundJobClient)
        {
        ...
        public async Task<bool> IsUserConfirmedAsync(string email)
        {
            ...
            return await _userManager.IsEmailConfirmedAsync(dbUser);
        }
        ...
        {
            var signingKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes("Who is the doctor?"));
